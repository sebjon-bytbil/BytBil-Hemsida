<?php
/*
Plugin Name: Bildeve Fordonsurval
        ...
        'fields' => array(
            ...
            array(
                ...
                'choices' => array(
                    ...
                    'Lista2' => 'Utan sökfunktion (För märken)',
                    'Favoriter' => 'Favoriter',
                    'Senaste' => 'Senaste',
                    'Sok' => 'Sökfunktion',
                ),
            ...
            array (
                'key' => 'field_55e6e56cc2a41',
                'label' => 'Generera kriteriesträng',
                'name' => 'criterias-generator',
                'type' => 'message',
                'message' => '<iframe src="http://access.bytbil.com/petermdemogrupp/Access/Home/Sok" style="width: 100%; height: 1950px;"></iframe>',
            ),
        ),
        'location' => array(
            array(
...
function bytbil_show_assortment($id)
{
    ...
    $assortment_alias = get_field('settings-bbalias','options');
