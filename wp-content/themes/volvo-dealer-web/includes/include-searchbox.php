...
$Location = "Locations=$post->SelectFacility";
...
$UsedState = "Used=$post->Used"; // Used, New or None


if (!isset($_GET['Used'])) {
    switch ($used) {
        case 'new':
            $UsedState = 'Used=rvppdkyg';
            break;
        case 'used':
            $UsedState = 'Used=sv3pdkyg';
            break;
    }
}
...
$OnlyNew = "OnlyNew=";
$OnlyImages = "OnlyImages=$post->Photo";
$OnlyVideo = "OnlyVideo=";
$OnlyVat = "OnlyVat=";
$OnlyEnvironment = "OnlyEnvironment=";

$Brand = 'Brand=fv4idkyg';
...
<div class="search-container">
    <h1>Sök Volvobilar</h1>

    <form action="<?php the_field('soksida', 'option'); ?>" name="search" method="get">
        <div class="row-fluid">

            <div class="span-nyberg col2 searchItemContainer">
                <div class="subject">Modell</div>
                <select class="FormItem" name="ModelName" id="ModelName">
                    <option value="">Alla</option>
                </select>
            </div>

            <div class="span-nyberg col2 searchItemContainer no-responsive">
                <div class="subject">Karroseri</div>
            ...
            <div class="span-nyberg col2 searchItemContainer">
                <div class="subject">Växellåda</div>
                <select class="FormItem" name="Gearbox" id="Gearbox">
                    <option value="">Alla</option>
                    <option value="gvwpdkyg">Automatisk</option>
                    <option value="4v8pdkyg">Manuell</option>
                    <option value="8vnpdkyg">Sekventiell</option>
                </select>
            </div>

            <div class="span-nyberg searchItemContainer">
                <?php $fuelCheck = explode('=', $Fuel); ?>
                <div class="subject">Drivmedel</div>
                <select class="FormItem" name="Fuel" id="Fuel">
                    ...
                    <option value="cvg5dkyg" <?php if ($fuelCheck[1] == 'cvg5dkyg') echo ' selected' ?>>Bensin/gas
                    </option>
                    ...
                    <option value="5vepdkyg" <?php if ($fuelCheck[1] == '5vepdkyg') echo ' selected' ?>>Hybrid
                        el/bensin
                    </option>
                    <option value="6vcpdkyg" <?php if ($fuelCheck[1] == '6vcpdkyg') echo ' selected' ?>>Naturgas
                    </option>
                </select>
            </div>
        ...
        <div class="row-fluid">
            <div class="span-nyberg  searchItemDoubleContainer">
                <div class="subject">Årsmodell</div>
            ...
            <div class="span-nyberg  searchItemDoubleContainer">
                ...
                <select class="FormMin" name="PriceFrom" id="PriceFrom">
                    ...
                    <option value="100000" <?php if ($priceFromCheck[1] == '100000') echo ' selected' ?>>100.000
                    </option>
                    <option value="120000" <?php if ($priceFromCheck[1] == '120000') echo ' selected' ?>>120.000
                    </option>
                    <option value="140000" <?php if ($priceFromCheck[1] == '140000') echo ' selected' ?>>140.000
                    </option>
                    <option value="160000" <?php if ($priceFromCheck[1] == '160000') echo ' selected' ?>>160.000
                    </option>
                    <option value="180000" <?php if ($priceFromCheck[1] == '180000') echo ' selected' ?>>180.000
                    </option>
                    <option value="200000" <?php if ($priceFromCheck[1] == '200000') echo ' selected' ?>>200.000
                    </option>
                    <option value="220000" <?php if ($priceFromCheck[1] == '220000') echo ' selected' ?>>220.000
                    </option>
                    <option value="240000" <?php if ($priceFromCheck[1] == '240000') echo ' selected' ?>>240.000
                    </option>
                    <option value="260000" <?php if ($priceFromCheck[1] == '260000') echo ' selected' ?>>260.000
                    </option>
                    <option value="280000" <?php if ($priceFromCheck[1] == '280000') echo ' selected' ?>>280.000
                    </option>
                    <option value="300000" <?php if ($priceFromCheck[1] == '300000') echo ' selected' ?>>300.000
                    </option>
                    <option value="320000" <?php if ($priceFromCheck[1] == '320000') echo ' selected' ?>>320.000
                    </option>
                    <option value="340000" <?php if ($priceFromCheck[1] == '340000') echo ' selected' ?>>340.000
                    </option>
                    <option value="360000" <?php if ($priceFromCheck[1] == '360000') echo ' selected' ?>>360.000
                    </option>
                    <option value="380000" <?php if ($priceFromCheck[1] == '380000') echo ' selected' ?>>380.000
                    </option>
                    <option value="400000" <?php if ($priceFromCheck[1] == '400000') echo ' selected' ?>>400.000
                    </option>

                </select>
                <?php $priceToCheck = explode('=', $PriceTo); ?>
                <select class="FormMax" name="PriceTo" id="PriceTo">
                    <option value="">Över 300000</option>
            ...
            <div class="span-nyberg searchItemDoubleContainer">
                ...
                <select class="FormMax" name="MilesTo" id="MilesTo">
                    <option value="">Över 20000</option>
            ...
            <div class="span-nyberg col2 searchItemContainer">
                <div class="subject">Sortering</div>
                <select class="FormItem" name="Sort" id="Sort">
                    <option value="">Välj...</option>
                    <option value="pv7pdkyg">Pris</option>
                    <option value="ivfpdkyg">Mil</option>
                    <option value="3v2pdkyg">År</option>
                </select>
        ...
        <div class="row-fluid">
            <div class="span-nyberg col2 searchItemContainer no-responsive">
                <?php
                $exclVATCheck = explode('=', $exclVAT);
                $photoCheck = explode('=', $OnlyImages);
                ?>
                <span class="checkbox-span"><label><input type="checkbox" name="exclVAT"
                                                          value="true" <?php if ($exclVATCheck[1] == 'true') {
                            echo "checked='checked'";
                        } ?>>Avdragbar moms</label></span>
                <span class="checkbox-span"><label><input class="checkbox" type="checkbox" value="true" name="Photo"
                                                          id="Photo" <?php if ($photoCheck[1] == 'true') {
                            echo "checked='checked'";
                        } ?>>Endast med bilder</label></span>
            </div>

            <div class="span-nyberg col2 searchItemContainer">
                <select class="FormItem" name="SelectFacility" id="SelectFacility">
                    <option value="">Ort</option>
                </select>
            </div>
            <div class="span-nyberg col2 searchItemContainer">
                <?php $usedCheck = explode('=', $UsedState); ?>

                <select class="FormItem" name="Used" id="Used">
                    <option value="">Nya och begagnade</option>
                    <option value="rvppdkyg" <?php if ($usedCheck[1] == 'rvppdkyg') {
                        echo " selected";
                    } ?>>Nya
                    </option>
                    <option value="sv3pdkyg" <?php if ($usedCheck[1] == 'sv3pdkyg') {
                        echo " selected";
                    } ?>>Begagnade
                    </option>
                </select>
            ...
            <div class="span-nyberg col2 searchItemContainer">
                <input type="submit" id="SearchButton" class="search-button" style="width: 100%" value="Sök bilar">
            </div>
        </div>
    </form>
</div>
<script type="text/javascript">
    ...
    function getModels() {
        var brand = 'fv4idkyg'; //Volvo id
        $.post(ajaxurl, {action: 'get_models', brand: brand}, function (data) {
            data = JSON.parse(data);

            $('#ModelName').html('');

            $('#ModelName').append('<option value="">Alla</option>');


            for (var i = 0; i < data.length; i++) {
                var currentModel = '<?php echo $_GET['ModelName']; ?>';
                var selected = '';
                if (data[i].Reference == currentModel) {
                    selected = ' selected';
                }
    ...
    function getOrter() {
        $.post(ajaxurl, {action: 'get_orter'}, function (data) {
            data = JSON.parse(data);
            $('#SelectFacility').html('');
            $('#SelectFacility').append('<option value="">Välj anläggning (alla)</option>');
            ...
            for (var i = 0; i < data.Items.length; i++) {
                ...
                var currentOrt = '<?php echo $_GET['SelectFacility']; ?>';
                var selected = '';
                if (item.Id == currentOrt) {
                    selected = ' selected';
                }
                $('#SelectFacility').append('<option value="' + item.Id + '"' + selected + '>' + item.Name + ' - ' + capitaliseFirstLetter(item.City.toLowerCase()) + '</option>');
            }
