...
function bytbil_show_employee($id, $cols = 3)
{
    ...
    ?>
    <div class="col-xs-12 col-sm-6 col-md-<?php echo $cols ?>">
        <article class="employee">
            <?php if ($image != null) { ?>
                <img src="<?php echo $image_url ?>"/>
            <?php } else { ?>
                <img src="<?php echo get_template_directory_uri() . '/images/employee/no-image.png'; ?>"/>
            <?php } ?>
            ...
            <span class="employee-contact">
                <?php while (has_sub_fields('employee-phonenumbers', $id)) : ?>
                    <a href="tel:<?php echo get_sub_field('employee-phonenumber-number'); ?>"
                       class="employee-phonenumber btn button btn-blue">
                        <span class="number">
                ...
                <?php endwhile; ?>
                <?php if (get_field('employee-email', $id)) { ?>
                    <a class="btn button btn-white employee-email"
                       href="mailto:<?php echo get_field('employee-email', $id); ?>">
                        <?php if (!$hide_email) : ?>
                            <?php echo '<i class="fa fa-fw fa-envelope"></i> Maila mig' ?>
                        <?php else : ?>
...
function bytbil_show_employee_list($list, $hide, $cols = 3)
{
    ...
    <h2><i class="fa fa-fw fa-users"></i> Personal</h2>
    <div class="row">
