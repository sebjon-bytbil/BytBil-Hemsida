    ...
    if (isset($redirect->url_to)) {
        if (is_numeric($redirect->url_to)) {
            ...
            if (get_permalink($redirect->url_to)) {
                ?>
                <a target="_blank" class="eps-url" href="<?php echo get_permalink($redirect->url_to); ?>"
                   title="<?php echo get_permalink($redirect->url_to); ?>">
                    <span
                        class="eps-url-root eps-url-startcap"><?php echo strtoupper(get_post_type($redirect->url_to)); ?></span><span
                        class="eps-url-root">ID: <?php echo $redirect->url_to; ?> </span><span
                        class="eps-url-fragment eps-url-endcap "><?php echo get_the_title($redirect->url_to); ?> </span>
                </a>
            <?php
            } else {
                ?>
            ...
            ?>
            <a target="_blank" class="eps-url" href="<?php echo esc_attr($redirect->url_to); ?>"
               title="<?php echo esc_attr($redirect->url_to); ?>">
