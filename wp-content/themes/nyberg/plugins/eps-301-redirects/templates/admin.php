...
<div class="wrap">
    ...
    <div id="donate-box" class="eps-panel">
        <div class="eps-padding">
            <p>Comments, questions, bugs and feature requests can be sent to: <a
                    href="mailto:plugins@eggplantstudios.ca">plugins@eggplantstudios.ca</a></p>
            <hr>
    ...
    <div class="left">
        <div class="eps-panel eps-margin-top">
            <form method="post" action="" class="eps-padding" enctype="multipart/form-data">
                ...
                <input type="submit" name="eps_redirect_upload" id="submit" class="button button-secondary"
                       value="Upload CSV"/>
                <br>
                <small class="eps-grey-text">Supply Columns: <strong>Status</strong> (301,302,inactive), <strong>Request
                        URL</strong>, <strong>Redirect To</strong> (ID or URL).
                </small>
            </form>
        </div>
        ...
        <div class="eps-panel left eps-margin-top">
            <form method="post" action="" class="eps-padding">
                <?php wp_nonce_field('eps_redirect_nonce', 'eps_redirect_nonce_submit'); ?>
                <input type="submit" name="eps_redirect_refresh" id="submit" class="button button-secondary"
                       value="Refresh Cache"/>
                <br>
                <small class="eps-grey-text">Refresh the cache if the dropdowns are out of date.</small>
            </form>
        </div>
    </div>
