...
{
    $plugin_array['bytbilslider'] = get_template_directory_uri() . '/plugins/bytbil_misc/js/bytbilslider.js';
    $plugin_array['personalorter'] = get_template_directory_uri() . '/plugins/bytbil_misc/js/personalorter.js';
    $plugin_array['bytbilpersonal'] = get_template_directory_uri() . '/plugins/bytbil_misc/js/bytbilpersonal.js';
    return $plugin_array;
}
...
{
    $plugin_array['wpse72394_button'] = get_template_directory_uri() . '/plugins/bytbil_misc/js/personallista.js';
    return $plugin_array;
}
