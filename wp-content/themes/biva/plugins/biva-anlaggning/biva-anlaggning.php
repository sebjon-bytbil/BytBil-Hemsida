<?php
/*
Plugin Name: Biva Anläggningar
Description: Skapa och visa Anläggningar.
Author: Sebastian Jonsson / Tobias Franzén : BytBil Nordic AB
Version: 2.0.1
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4">
            <span class="facility_address">
                ...
                <?php echo get_the_title($id); ?><br>
                <?php bytbil_show_other_facility_address($id); ?><br><br>
            </span>
        </div>
        <div class="col-xs-12 col-sm-4 col-md-4">
...
function bytbil_show_facility_phonenumbers($id)
{
    while (has_sub_fields('facility-phonenumbers', $id)) : ?>
    	...
    	<?php the_sub_field('facility-phonenumber-title'); ?>
    </span>
...
function bytbil_show_facility_openhours($id, $columns = false, $cols = 12)
{
    ...
    if ($tot >= 12) : ?>
        ...
        <?php $tot = 0; endif;
    ?>
    <?php if ($columns == true) { ?><!--<div class="col-xs-12 col-sm-12 no-padding">--><?php } ?>
    <div class="department col-xs-12 col-sm-<?php echo $cols ?>">
        ...
        <span class="facility_openhours">
            <?php while (has_sub_fields('facility-department-openhours', $id)) : ?>
                ...
                <span class="facility-department-openhours-time"><?php the_sub_field('facility-department-openhours-time'); ?></span><br>
            <?php endwhile; ?>
        </span><br>
    </div>
