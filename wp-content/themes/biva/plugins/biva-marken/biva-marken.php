    ...
    register_field_group(array(
        ...
        'fields' => array(
            array(
                ...
                'library' => 'all',
                'instructions' => 'Ladda upp eller välj en märkeslogo',
            ),
            array(
                'key' => 'field_3582a619e9438',
                'label' => 'Bild (alternativ)',
                'name' => 'brand_image_alternative',
                'type' => 'image',
                'save_format' => 'url',
                'preview_size' => 'thumbnail',
                'library' => 'all',
...
function bytbil_brands()
{
    ...
    $brands = get_field('sitesetting-brands', $settingspage->ID);
    if ($brands) { ?>
        <div class="brands">
            <?php
