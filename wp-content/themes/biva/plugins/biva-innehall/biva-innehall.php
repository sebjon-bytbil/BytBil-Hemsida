<?php
/*
Plugin Name: Biva Innehållsblock
Description: Gör det möjligt att använda sig av innehållsblock i BytBil CMS 2.0
Author: Sebastian Jonsson / Leo Starcevic / Tobias Franzén : BytBil Nordic AB
Version: 2.0
        ...
        'fields' => array(
            ...
            array(
                ...
                'sub_fields' => array(
                    ...
                    array(
                        'key' => 'field_1249c2e7ec31438',
                        'label' => 'Expanderar blockgrupp',
                        'name' => 'setting-expandable',
                        'type' => 'true_false',
                        'message' => '',
                        'default_value' => 0,
                    ),
                    array(
                        'key' => 'field_541c21389e53ac6fe876',
                        'label' => 'Expandera grupp',
                        'name' => 'setting-expandable-group',
                        'type' => 'text',
                        'column_width' => '',
                        'default_value' => '',
                        'placeholder' => '',
