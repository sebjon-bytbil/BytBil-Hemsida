...
{
    $url = "/wp-content/themes/landrinsbil/plugins/landrins-puffar/js/bb-plugs-modal.js";
...
if (function_exists("register_field_group")) {
    register_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'field_541a8ddbc6a28',
                'label' => 'Knappar',
                'name' => '',
                'type' => 'tab',
            ),
            array(
                'key' => 'field_541adc115es36',
                'label' => 'Knappinställningar',
                'name' => 'plug-buttons',
                'type' => 'repeater',
                'sub_fields' => array(
                    array(
                        'key' => 'field_541adc245e152',
                        'label' => 'Knapptext',
                        'name' => 'plug-button-text',
                        'type' => 'text',
                        'column_width' => '',
                        'default_value' => '',
                        'placeholder' => '',
                    ...
                    array(
                        'key' => 'field_541c8836d1d20',
                        'label' => 'Länktyp',
                        'name' => 'plug-button-link-type',
                        'type' => 'radio',
                        'choices' => array(
                            'internal' => 'Lokal sida',
                            'external' => 'Extern URL',
                    ...
                    array(
                        'key' => 'field_541a8995d1f62',
                        'label' => 'Sida',
                        'name' => 'plug-button-link-internal',
                        'type' => 'page_link',
                        'conditional_logic' => array(
                            'status' => 1,
                            'rules' => array(
                                array(
                                    'field' => 'field_541c8836d1d20',
                                    'operator' => '==',
                                    'value' => 'internal',
                                ),
                            ),
                    ...
                    array(
                        'key' => 'field_152adc245e926',
                        'label' => 'URL',
                        'name' => 'plug-button-link-external',
                        'type' => 'text',
                        'conditional_logic' => array(
                            'status' => 1,
                            'rules' => array(
...
function bytbil_show_plug($id, $size = 12)
{
    ...
    <div class="col-xs-12 col-sm-<?php echo $plug_size; ?>">
         ...
         <?php } ?>
             ...
             <?php if (have_rows('plug-buttons', $id)) { ?>
                 <span class="plug-buttons">
				<?php while (have_rows('plug-buttons', $id)) : the_row();
                    $button_link_text = get_sub_field('plug-button-text');
                    $button_link_internal = get_sub_field('plug-button-link-internal');
                    $button_link_external = get_sub_field('plug-button-link-external');
                    $button_link_type = get_sub_field('plug-button-link-type');
                    ?>
                    <a href="<?php ($button_link_type == 'internal') ? print($button_link_internal) : print($button_link_external) ?>"
                       target="_self">
                        <button class="btn btn-default"><?php echo $button_link_text; ?></button>
                    </a>
                <?php endwhile; ?>
            </span>
             <?php } ?>
