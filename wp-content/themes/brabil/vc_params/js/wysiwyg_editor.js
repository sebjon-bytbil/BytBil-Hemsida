        ...
        if (undefined !== textareas && textareas.length > 0) {
            textareas.each(function(i) {
                ...
                tinymce.init({
                    ...
                    toolbar: 'bold,italic,strikethrough,bullist,numlist,hr,blockquote,alignleft,aligncenter,alignright,addimage,link,unlink,forecolor,backcolor,formatselect,icon-button,icon_button',
                    menubar: false,
                    selector: '#' + id,
