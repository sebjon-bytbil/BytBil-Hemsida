                        ...
                        while (have_rows('row-content')) {
                            ...
                            if($content_tabs == 'true'){
                                ...
                                <div class="tab-pane <?php echo $content_tab_class; ?>" id="<?php echo $content_tab_slug; ?>">
                                    <div id="<?php echo $page_id . '-' . $content_count; ?>" class="col-xs-12 <?php echo get_row_layout(); ?>">
                                        <?php

                                            if( get_row_layout() ) {
                                                require("layouts/".get_row_layout().".php");
                                            }
                                ...
                                <div id="<?php echo $page_id . '-' . $content_count; ?>" class="col-xs-12 col-sm-<?php echo $content_width; ?> <?php echo get_row_layout(); ?>">

                                    <?php

                                    if( get_row_layout() ) {
                                        require "layouts/".get_row_layout()."_old.php";
                                    }
