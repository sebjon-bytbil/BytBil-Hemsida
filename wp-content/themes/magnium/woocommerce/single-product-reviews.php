...
<div id="reviews" class="reviews-wrapper">
	...
	<?php endif; ?>
	<a class="btn mgt-button mgt-size-large mgt-align-center" id="product_show_review_form"><?php _e('Write a review', 'magnium'); ?></a>
			...
			<div id="review_form">
				<?php
					...
					$comment_form = array(
						...
						'label_submit'  => __( 'Submit review', 'magnium' ),
						'logged_in_as'  => '',
						'comment_field' => ''
					);
