...
<?php if(!$this->repository_has_subscription($repository_id) || !empty($subscription_no_match)): ?>            
            ...
            <a class="button-primary" target="_blank" style="margin-bottom:10px;" href="<?php echo $this->append_parameters_to_buy_url($product['url'], $args) ?>"><?php printf(__('Buy %s', 'installer'), $args['product_name']) ?></a> 
