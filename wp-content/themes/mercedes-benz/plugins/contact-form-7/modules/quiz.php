    ...
    <div id="wpcf7-tg-pane-quiz" class="hidden">
        <form action="">
            ...
            <table>
                ...
                <tr>
                    <td><?php echo esc_html(__('Quizzes', 'contact-form-7')); ?><br/>
                        ...
                        <span
                            style="font-size: smaller"><?php echo esc_html(__("* quiz|answer (e.g. 1+1=?|2)", 'contact-form-7')); ?></span>
                    </td>
                </tr>
            </table>
            ...
            <div
                ...
                <br/><input type="text" name="quiz" class="tag wp-ui-text-highlight code" readonly="readonly"
