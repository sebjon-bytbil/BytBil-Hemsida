    ...
    <div id="wpcf7-tg-pane-acceptance" class="hidden">
        <form action="">
            ...
            <table>
                ...
                <tr>
                    <td colspan="2">
                        <br/><input type="checkbox" name="default:on"
                                    class="option"/>&nbsp;<?php echo esc_html(__("Make this checkbox checked by default?", 'contact-form-7')); ?>
                        <br/><input type="checkbox" name="invert"
                                    class="option"/>&nbsp;<?php echo esc_html(__("Make this checkbox work inversely?", 'contact-form-7')); ?>
                        <br/><span
                            style="font-size: smaller;"><?php echo esc_html(__("* That means visitor who accepts the term unchecks it.", 'contact-form-7')); ?></span>
                    </td>
                </tr>
            </table>
            ...
            <div
                ...
                <br/><input type="text" name="acceptance" class="tag wp-ui-text-highlight code" readonly="readonly"
