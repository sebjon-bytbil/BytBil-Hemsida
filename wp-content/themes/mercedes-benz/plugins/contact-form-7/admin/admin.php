...
function wpcf7_admin_add_new_page()
{
    ...
    <div class="wrap">
        ...
        <p>
            <a href="<?php echo esc_url(add_query_arg(array('locale' => $default_locale), menu_page_url('wpcf7-new', false))); ?>"
               class="button button-primary"/><?php echo esc_html(__('Add New', 'contact-form-7')); ?></a></p>
        ...
        <form action="" method="get">
            ...
            <select name="locale">
                <option value=""
                        selected="selected"><?php echo esc_html(__('(select language)', 'contact-form-7')); ?></option>
...
function wpcf7_welcome_panel()
{
    ...
    <div id="welcome-panel" class="<?php echo esc_attr($classes); ?>">
        ...
        <a class="welcome-panel-close"
           href="<?php echo esc_url(menu_page_url('wpcf7', false)); ?>"><?php echo esc_html(__('Dismiss', 'contact-form-7')); ?></a>
        ...
        <div class="welcome-panel-content">
            <div class="welcome-panel-column-container">
                <div class="welcome-panel-column">
                    ...
                    <p><a href="<?php echo esc_url(__('http://contactform7.com/donate/', 'contact-form-7')); ?>"
                          class="button button-primary"
                          target="_blank"><?php echo esc_html(__('Donate', 'contact-form-7')); ?></a></p>
                </div>
                ...
                <div class="welcome-panel-column">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo esc_url(__('http://contactform7.com/getting-started-with-contact-form-7/', 'contact-form-7')); ?>"
                               target="_blank"><?php echo esc_html(__("Getting Started with Contact Form 7", 'contact-form-7')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo esc_url(__('http://contactform7.com/admin-screen/', 'contact-form-7')); ?>"
                               target="_blank"><?php echo esc_html(__("Admin Screen", 'contact-form-7')); ?></a></li>
                        <li>
                            <a href="<?php echo esc_url(__('http://contactform7.com/tag-syntax/', 'contact-form-7')); ?>"
                               target="_blank"><?php echo esc_html(__("How Tags Work", 'contact-form-7')); ?></a></li>
                        <li>
                            <a href="<?php echo esc_url(__('http://contactform7.com/setting-up-mail/', 'contact-form-7')); ?>"
                               target="_blank"><?php echo esc_html(__("Setting Up Mail", 'contact-form-7')); ?></a></li>
                    </ul>
                </div>
                ...
                <div class="welcome-panel-column">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo esc_url(__('http://contactform7.com/spam-filtering-with-akismet/', 'contact-form-7')); ?>"
                               target="_blank"><?php echo esc_html(__("Spam Filtering with Akismet", 'contact-form-7')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo esc_url(__('http://contactform7.com/save-submitted-messages-with-flamingo/', 'contact-form-7')); ?>"
                               target="_blank"><?php echo esc_html(__("Save Messages with Flamingo", 'contact-form-7')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo esc_url(__('http://contactform7.com/selectable-recipient-with-pipes/', 'contact-form-7')); ?>"
                               target="_blank"><?php echo esc_html(__("Selectable Recipient with Pipes", 'contact-form-7')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo esc_url(__('http://contactform7.com/tracking-form-submissions-with-google-analytics/', 'contact-form-7')); ?>"
                               target="_blank"><?php echo esc_html(__("Tracking with Google Analytics", 'contact-form-7')); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
