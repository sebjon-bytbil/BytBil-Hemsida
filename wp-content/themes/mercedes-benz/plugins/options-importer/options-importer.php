    ...
    class WP_Options_Importer
    {
        ...
        public function export_filters()
        {
            ...
            <p><label><input type="radio" name="content"
                             value="options"/> <?php _e('Options', 'wp-options-importer'); ?></label></p>
        <?php
        }
        ...
        private function pre_import()
        {
            ...
            <form action="<?php echo admin_url('admin.php?import=wp-options-import&amp;step=2'); ?>" method="post">
                ...
                <p>
                    <label><input type="radio" class="which-options" name="settings[which_options]" value="default"
                                  checked="checked"/> <?php _e('Default Options'); ?></label>
                    <br/><label><input type="radio" class="which-options" name="settings[which_options]"
                                       value="all"/> <?php _e('All Options'); ?></label>
                    <br/><label><input type="radio" class="which-options" name="settings[which_options]"
                                       value="specific"/> <?php _e('Specific Options'); ?></label>
                </p>
                ...
                <div id="option_importer_details">
                    ...
                    <p>
                        <a href="#" class="options-bulk-select"
                           data-select="all"><?php _e('Select All', 'wp-options-importer'); ?></a>
                        | <a href="#" class="options-bulk-select"
                             data-select="none"><?php _e('Select None', 'wp-options-importer'); ?></a>
                        | <a href="#" class="options-bulk-select"
                             data-select="defaults"><?php _e('Select Defaults', 'wp-options-importer'); ?></a>
                    </p>
                        ...
                        <?php foreach ($this->import_data['options'] as $option_name => $option_value) : ?>
                            ...
                            <tr>
                                <td><input type="checkbox" name="options[]"
                                           value="<?php echo esc_attr($option_name) ?>" <?php checked(in_array($option_name, $whitelist)) ?> />
                                </td>
                                ...
                                <?php
                                    ...
                                    <td>
                                        <pre><?php echo esc_html($option_value) ?></pre>
                                    </td>
                                <?php endif ?>
                            </tr>
                        <?php endforeach; ?>
                ...
                <p>
                    ...
                    <label
                        for="override_current"><?php _e('Override existing options', 'wp-options-importer'); ?></label>
                </p>
