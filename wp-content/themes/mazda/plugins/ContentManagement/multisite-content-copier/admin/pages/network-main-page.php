...
class Multisite_Content_Copier_Network_Main_Menu extends Multisite_Content_Copier_Admin_Page
{
            ...
            <ul>
                ...
                <li class="<?php $this->wizard->breadcrumb_class(4); ?>">
                    <a <?php echo $this->wizard->get_breadcrumb_href(4); ?>><span
                            class="badge">4</span> <?php _e('Select Destinations', MULTISTE_CC_LANG_DOMAIN); ?></a></li>
        ...
        <script>
            jQuery(document).ready(function ($) {
                ...
                $('#wizardform').submit(function (e) {
                    var list_items = $('#the-list .check-column input:checked');
    ...
    private function render_post_selector($blog_id, $type)
    {
        ...
        <input type="checkbox" name="settings[copy_parents]" checked="true" style="display: none;">
        ...
        if ('all' != $dest_blog_type) {
            ...
            foreach ($dest_blogs_ids as $dest_blog_id) {
                ...
                if ($dest_blog_id != $src_blog_id) {
                    ...
                    // cURL
                    $blog_details = get_blog_details($dest_blog_id);
                    $args = array(
                        'timeout'     => 30,
                        'redirection' => 5,
                        'httpversion' => '1.0',
                    ...
                    $response = wp_remote_get($blog_details->siteurl, $args);
            ...
            ?>
            <p>
                <?php _e('Your selected items have been pushed.', MULTISTE_CC_LANG_DOMAIN); ?>
            </p>
            <script>
