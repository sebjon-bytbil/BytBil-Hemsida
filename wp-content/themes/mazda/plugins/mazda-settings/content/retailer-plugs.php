...
/* Register fields for Post Type Plug */
...
if(function_exists("register_field_group"))
{
    register_field_group(array (
        ...
        'fields' => array (
            array (
                'key' => 'field_552bb74a3c382',
                'label' => 'Utseende',
                'name' => '',
                'type' => 'tab',
            ),
            array (
                'key' => 'field_552bb79a3c383',
                'label' => 'Ikon',
                'name' => 'plug-icon',
                'type' => 'font-awesome',
                'default_value' => 'null',
            ...
            array (
                'key' => 'field_552bb7a83c384',
                'label' => 'Färg',
                'name' => 'plug-color',
                'type' => 'select',
                'instructions' => 'Välj vilken färg du vill ha på puffen',
                'choices' => array (
                    'gray' => 'Mörkgrå',
                    'blue' => 'Blå',
                    'white' => 'Vit',
            ...
            array (
                'key' => 'field_552bb8033c385',
                'label' => 'Länkning',
                'name' => '',
                'type' => 'tab',
            ),
            array (
                'key' => 'field_552bb8113c386',
                'label' => 'Länktyp',
                'name' => 'plug-link',
                'type' => 'radio',
                'choices' => array (
            ...
            array (
                'key' => 'field_552bb84d3c388',
                'label' => 'URL',
                'name' => 'plug-external-url',
                'type' => 'text',
                'conditional_logic' => array (
                    'status' => 1,
                    'rules' => array (
...
function show_plug($id)
{ ?>

    <div class="col-xs-12 col-md-6">
        <?php
        $plug_link = get_field('plug-link', $id);
        
        if($plug_link == 'internal'){
            $url = get_field('plug-page-link', $id);
            $target = '_self';
        }
        elseif($plug_link == 'external'){
            $url = get_field('plug-external-url', $id);
            $target = '_blank';
        }
        ?>
        <a href="<?php echo $url; ?>" class="button <?php echo get_field('plug-color', $id); ?> button-plug" target="<?php echo $target; ?>">
            <i class="fa fa-fw <?php echo get_field('plug-icon', $id); ?>"></i> <?php echo get_the_title($id); ?>
        </a>
    </div>
