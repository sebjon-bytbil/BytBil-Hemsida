...
angular.module("ElasticAccess", ["ElasticAccess.filters", "ElasticAccess.adapters", "angularjs-dropdown-multiselect", "infinite-scroll", "angularSpinner"])
...
angular.module('ElasticAccess').run(['$templateCache', function($templateCache) {
    ...
    $templateCache.put('templates/Filter.html',
        "<div class=\"wrapper\" ng-controller=\"SearchListCtrl\">\n" +
        "    <div class=\"col-xs-12\">\n" +
        "        <div class=\"row\">\n" +
        "            <h2>Din sökning resulterade i {{ resultCount }} fordon</h2>\n" +
        "        </div>\n" +
        "        <div class=\"row\">\n" +
        ...
        "                    <a class=\"form-control\" data-toggle=\"dropdown\">{{ sortLabel }}<span class=\"caret\"></span></a>\n" +
    ...
    $templateCache.put('templates/List.html',
        ...
        "            <div ng-repeat=\"chunk in cars\" class=\"row\">\n" +
    ...
    $templateCache.put('templates/SingleObject.html',
        ...
        "    <bb-flexslider class=\"header-slider\" images=\"car.images.image\"></bb-flexslider>\n" +
        ...
        "                            <li><a href=\"#finance\">Finansiering</a></li>\n" +
        ...
        "                </div>\n" +
        "                <div id=\"properties\" class=\"scroll col-xs-12 col-sm-4\">\n" +
        "                    <h3><strong>{{ car.brand }}</strong> {{ car.model }} {{ car.modeldescription }}</h3>\n" +
        "                    <h3 class=\"price\">{{ car[\"price-active\"] | formatNumber }}kr</h3>\n" +
        ...
        "                        <dt>Anläggning</dt><dd>{{ car.seller }}</dd>\n" +
        "                    </dl>\n" +
        "\n" +
        "                </div>\n" +
        "            </div>\n" +
        ...
        "        </div>\n" +
        "    </div>\n" +
        "    <div id=\"finance\" class=\"scroll col-xs-12\">\n" +
        "        <div class=\"wrapper\">\n" +
        "            <div class=\"row\">\n" +
        "                <div class=\"col-xs-12\">\n" +
        "                    <h2>Finansiering</h2>\n" +
        "                    <p>Med ett billån hos Upplands Motor kan du låna upp till 80% av bilens pris- och även byuta din nuvarande bil mot resterande kontantinsats.<br/>\n" +
        "                    Ändra alternativen nedan för att direkt se månadskostnaden för bilen.</p>\n" +
        "                </div>\n" +
        "                <div class=\"col-xs-12 col-sm-4\">\n" +
        "                    <div class=\"vehicle-image\">\n" +
        "                        <img class=\"img-responsive\" src=\"{{ car.images.image[0] }}\" alt=\"\"/>\n" +
        ...
        "    </div>\n" +
        "\n" +
        "    <div ng-include src=\"'templates/partials/ContactForm.html'\"></div>\n" +
        "\n" +
        "    <div ng-include src=\"'templates/partials/SimilarCars.html'\"></div>\n" +
        "\n" +
        "</div>"
    );
    ...
    $templateCache.put('templates/partials/ContactForm.html',
        ...
        "                            <button class=\"button green\">Växel</button>\n" +
        "                        </div>\n" +
        "                        <div class=\"col-xs-12\">\n" +
        "                            <div id=\"contactForm\" class=\"col-sm-8 col-xs-12\">\n" +
        "                                <div class=\"row\">\n" +
        ...
        "\n" +
        "                                <div class=\"vehicle-image\">\n" +
        "                                    <div class=\"image\" style=\"\" bb-lazy-load=\"'{{ car.images.image[0]}}' \">\n" +
        ...
        "                                    </h4>\n" +
        "                                    <span>{{ car.yearmodel }} / {{ car.miles }} mil</span>\n" +
        "                                    <div class=\"row\">\n" +
        "                                        <h4 class=\"col-xs-6 vehicle-price bold\"><strong>{{ car[\"price-active\"] }}kr</strong></h4>\n" +
    ...
    $templateCache.put('templates/partials/Finance.html',
        ...
        "        <div class=\"item keyvalue\"><span class=\"finance-label\">Pris</span><span class=\"value\" id=\"Price\">{{ financeInfo.price }} kr</span></div>\n" +
        ...
        "        <span class=\"monthlyPayment\">{{ financeInfo.montlhlyPayment | formatNumber | formatPrice }}</span> / månad\n" +
        "    </div>\n" +
        "</div>\n" +
        "\n"
    );
    ...
    $templateCache.put('templates/partials/FinanceSliderCash.html',
        ...
        "    <label class=\"col-sm-6\">Kontaktinsats</label>\n" +
        "    <span class=\"col-sm-6\" id=\"cash-label\">{{ data.downPayment }} kr</span>\n" +
    ...
    $templateCache.put('templates/partials/Flexslider.html',
        ...
        "                <img class=\"img-responsive\" ng-src=\"{{ image }}\" alt=\"\" style=\"\">\n" +
        "                <div class=\"image-overlay\"></div>\n" +
        "            </li>\n" +
        "        </ul>\n" +
        "    </div>\n" +
    ...
    $templateCache.put('templates/partials/GridItem.html',
        ...
        "            <span class=\"vehicle-version\">{{ car.modeldescription }}</span>\n" +
        "        </h4>\n" +
        "        <span class=\"vehicle-price bold\"><strong>{{ car[\"price-active\"] | formatNumber }}kr</strong></span>\n" +
        "    </div>\n" +
        "</a>"
    );
    ...
    $templateCache.put('templates/partials/RangeSelect.html',
        ...
        "    <a class=\"btn dropdown-toggle selectpicker btn-form-white form-control\" data-toggle=\"dropdown\">{{ title }} <span class=\"caret\"></span></a>\n" +
            ...
            link: function (scope, el, attrs) {
                scope.$watch(attrs.bbLazyLoad, function () {
                    ...
                    ImageService.check(src).then(function () {
                        ...
                        // Not loaded
                        el.css("background", "url(http://customcms.bytbil.com/wp-content/uploads/sites/2/2015/06/upplands-no-image.jpg)");
                    });
                });
            }
        }
...
angular.module("ElasticAccess").controller("SetupCtrl", function($location, $scope, $rootScope) {
    ...
    $scope.init = function (search, filter, list, loadType, loadPage){
        if(search){
            $scope.search = true;
        }
        if(filter){
...
angular.module("ElasticAccess")
    .controller("SearchListCtrl", ["$location", "$scope", "SearchService", "$rootScope", "Searches", "usSpinnerService", function ($location, $scope, SearchService, $rootScope, Searches, usSpinnerService) {
        var self = this;
        ...
        var fetchCars = function () {
            ...
            SearchService.getList($scope.search).then(function (res) {
                ...
                if(isNaN($scope.totalCount)){
                    $scope.totalCount = Searches.lastResponse.total;
                }
        ...
        $scope.$watch("search", function (val) {
            usSpinnerService.spin('spinner');
            //$scope.multiselects.brand.data = multiselectEvents.getSingleData("brand");
        ...
        $scope.$watch("search.brand", function (val) {
            if (!$scope.data) {
                return;
            }
...
angular.module("ElasticAccess")
    .controller("CarListCtrl", ["ScrollList", "$scope", "Searches", "CarFetcher", "SearchService", "$location", "$rootScope", "usSpinnerService", function (ScrollList, $scope, Searches, CarFetcher, SearchService, $location, $rootScope, usSpinnerService) {
        ...
        $scope.fetchMoreCars = function(){
            CarFetcher.fetch(Searches, SearchService, $rootScope);
        };
    ...
    .factory('ScrollList', ["$location", "Searches", "CarFetcher", "SearchService", "$rootScope", function($location, Searches, CarFetcher, SearchService, $rootScope){
    ...
    .service("CarFetcher", function(){
        return {
            fetch: function(Searches, SearchService, $rootScope){
                var loadType = $rootScope.loadMoreCars;
...
angular.module("ElasticAccess")
    .controller("ObjectCtrl", ["$scope", "SearchService", "$location", "usSpinnerService", function ($scope, SearchService, $location, usSpinnerService) {
        $scope.objectUrl = "";
        $scope.monthly = 0;
