...
class IntranetHandler{
    ...
    function get_company_page_slug(){
        $query = get_posts( array( 'post_type' => 'page', 'meta_key' => '_wp_page_template', 'meta_value' => 'foretag.php' ) );
    ...
    {
        wp_enqueue_script('intranet', '/wp-content/themes/upplands-motor/plugins/intranet/js/intranet.js', array(), '1.0.0', true);
    }
