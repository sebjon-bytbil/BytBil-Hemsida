    ...
    <div class="col-xs-12 col-sm-4">
        <div class="vehicle-list-item block white-bg">
            ...
            <div class="vehicle-list-buttons">
                <a href="<?php echo $page; ?>" class="button <?php echo $brand_slug; ?>">Läs mer</a>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    if ($model_engines) {
                                        ...
                                        <div class="row engines-accordions">
                                            ...
                                            /*echo '<pre>'; var_dump($model_engines); '</pre>';*/
                                            $engine_ids = array();    
