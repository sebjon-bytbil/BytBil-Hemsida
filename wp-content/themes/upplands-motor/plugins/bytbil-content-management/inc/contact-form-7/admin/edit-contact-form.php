...
<div class="wrap">
    ...
    if ($post) :
        ...
        <form method="post"
            ...
            <input type="hidden" id="wpcf7-id" name="wpcf7-id"
                   value="<?php echo (int)get_post_meta($post->id(), '_old_cf7_unit_id', true); ?>"/>
            ...
            <div id="poststuff" class="metabox-holder">
                ...
                <div id="titlediv">
                    <input type="text" id="wpcf7-title" name="wpcf7-title" size="80"
                           value="<?php echo esc_attr($post->title()); ?>"<?php echo $disabled; ?> />

                    <?php if (!$post->initial()) : ?>
                        <p class="tagcode">
                            <?php echo esc_html(__("Copy this code and paste it into your post, page or text widget content.", 'contact-form-7')); ?>
                            <br/>

                            <input type="text" id="contact-form-anchor-text" onfocus="this.select();"
                                   readonly="readonly" class="wp-ui-text-highlight code"/>
                        </p>

                        <p class="tagcode" style="display: none;">
                            <?php echo esc_html(__("Old code is also available.", 'contact-form-7')); ?><br/>

                            <input type="text" id="contact-form-anchor-text-old" onfocus="this.select();"
                                   readonly="readonly" class="wp-ui-text-highlight code"/>
                        </p>
                    <?php endif; ?>
                    ...
                    <?php if (current_user_can('wpcf7_edit_contact_form', $post_id) && !$post->initial()) : ?>
                        <div class="actions-link">
                            ...
                            <input type="submit" name="wpcf7-copy" class="copy"
                                   value="<?php echo esc_attr(__('Duplicate', 'contact-form-7')); ?>"
                            ...
                            <input type="submit" name="wpcf7-delete" class="delete"
                                   value="<?php echo esc_attr(__('Delete', 'contact-form-7')); ?>"
