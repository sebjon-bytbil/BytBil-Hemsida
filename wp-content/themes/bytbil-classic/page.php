                    ...
                    <div class="col-xs-12 col-sm-4 col-lg-3" id="sidebar">
                        <?php if (get_field('sidebar-contents')) : while (have_rows('sidebar-contents')) : the_row();
                            ...
                            if ($type == 'wysiwyg') {
                                ...
                                if ($menu_type == 'page') {
                                    // {Post ID, int/string}, {args, array}, {first, bool (kommer antagligen alltid vara true)}
                                    bytbil_show_sidebar_menu($post->ID, array("echo" => true, "class" => "sidebar-menu"), true);
                                ...
                                the_sub_field("sidebar-content-html");
                            }
                            ?>
                        <?php endwhile; endif; ?>
                    </div>
