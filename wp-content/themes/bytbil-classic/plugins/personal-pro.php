<?php
/**
 * Plugin Name: BytBil Personal Pro
    ...
    register_field_group(array(
        ...
        'fields' => array(
            array(
                ...
                'library' => 'all',
                'instructions' => 'Ladda upp eller välj en bild som skall visas på personen',
            ),
            array(
                ...
                'formatting' => 'none',
                'maxlength' => '',
                'instructions' => 'Ange personens arbetstitel',
            ),
            array(
                ...
                'type' => 'repeater',
                'instructions' => 'Lägg till och fyll i telefonnummer för till personen',
                'sub_fields' => array(
                    array(
            ...
            array(
                ...
                'prepend' => '',
                'append' => '',
                'instructions' => 'Ange personens mailadress',
            ),
            array(
                ...
                'allow_null' => 0,
                'multiple' => 0,
                'instructions' => 'Välj vilken anläggning personen tillhör',
            ),
        ),
        'location' => array(
            array(
    ...
    register_field_group(array(
        ...
        'fields' => array(
            array(
                ...
                'type' => 'repeater',
                'instructions' => 'Lägg till personer i personallistan',
                'sub_fields' => array(
                    array(
                        ...
                        'allow_null' => 0,
                        'multiple' => 0,
                        'instructions' => 'Välj vilken person som skall ha denna plats i listan',
                    ),
                ),
                'row_min' => '',
                'row_limit' => '',
            ...
            <div class="col-xs-12 employees">
                ...
                if ($employees):
                    foreach ($employees as $employee):
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 employee">
