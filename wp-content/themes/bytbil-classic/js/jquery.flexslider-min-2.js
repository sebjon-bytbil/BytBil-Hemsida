...
(function (e) {
    ...
    e.flexslider = function (t, n) {
        ...
        var i = r.vars.namespace, s = ("ontouchstart"in window || window.DocumentTouch && document instanceof DocumentTouch) && r.vars.touch, o = "click touchend", u = "", a, f = r.vars.direction === "vertical", l = r.vars.reverse, c = r.vars.itemWidth > 0, h = r.vars.animation === "fade", p = r.vars.asNavFor !== "", d = {};
        focused = true;
        ...
        d = {
            init: function () {
                ...
                setup: function () {
                    ...
                    var t = r.vars.controlNav === "thumbnails" ? "control-thumbs" : "control-paging", n = 1, s;
                ...
                function v(f) {
                    ...
                    if (r.animatingTo === r.currentSlide && !a && !(o === null)) {
                        var c = l ? -o : o, p = c > 0 ? r.getTarget("next") : r.getTarget("prev");
        ...
        r.flexAnimate = function (t, n, o, u, a) {
            ...
            if (!r.animating && (r.canAdvance(t, a) || o) && r.is(":visible")) {
                ...
                if (!h) {
                    var m = f ? r.slides.filter(":first").height() : r.computedW, g, y, b;
                    if (c) {
                        g = r.vars.itemMargin;
