        ...
        <form action="">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <br/><input type="checkbox" name="multiple"
                                    class="option"/>&nbsp;<?php echo esc_html(__('Allow multiple selections?', 'contact-form-7')); ?>
                        <br/><input type="checkbox" name="include_blank"
            ...
            <div
                ...
                <br/><input type="text" name="select" class="tag wp-ui-text-highlight code" readonly="readonly"
