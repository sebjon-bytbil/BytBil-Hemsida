...
class GADASH_Settings
{
    ...
    public static function frontend_settings()
    {
        ...
        <form name="ga_dash_form" method="post"
            ...
            <div class="wrap">
                <?php echo "<h2>" . __("Google Analytics Frontend Settings", 'ga-dash') . "</h2>"; ?>
                <hr>
            </div>
            <div id="poststuff">
                        ...
                        <div class="settings-wrapper">
                            <div class="inside">
                                ...
                                <table class="options">
                                    ...
                                    <tr>
                                        <td class="roles title"><label
                                                for="ga_dash_access_front"><?php _e("Show stats to: ", 'ga-dash'); ?></label>
                                        </td>
                                        <td class="roles">
                                            <?php
                                            if (!isset ($wp_roles)) {
                                                ...
                                                <tr>
                                                    ...
                                                    if ($role != 'subscriber') {
                                                        ...
                                                        <td><label> <input
                                                                    ...
                                                                    value="<?php echo $role; ?>"
                                                                    <?php if (in_array($role, $options['ga_dash_access_front']) OR $role == 'administrator') echo 'checked="checked"';
                                                                    if ($role == 'administrator') echo 'disabled="disabled"'; ?> />
                                                                <?php echo $name; ?>
                                                            </label></td>
                                                    <?php
                                                    }
                                    ...
                                    <tr>
                                        <td colspan="2" class="title">
                                            ...
                                            <div
                                                class="switch-desc"><?php _e(" show page visits and visitors in frontend (after each article)", 'ga-dash'); ?></div>
                                    ...
                                    <tr>
                                        <td colspan="2" class="title">
                                            ...
                                            <div
                                                class="switch-desc"><?php _e(" show page searches (after each article)", 'ga-dash'); ?></div>
                                    ...
                                    <tr>
                                        <td colspan="2" class="submit"><input type="submit"
                                                                              ...
                                                                              value="<?php _e('Update Options', 'ga-dash') ?>"/>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <div class="settings-wrapper">
                            <div class="inside">
                                ...
                                <table class="options">
                                    ...
                                    <tr>
                                        <td class="roles title"><label
                                                for="ga_dash_access_back"><?php _e("Show stats to: ", 'ga-dash'); ?></label>
                                        </td>
                                        <td class="roles">
                                            <?php
                                            if (!isset ($wp_roles)) {
                                                ...
                                                <tr>
                                                    ...
                                                    if ($role != 'subscriber') {
                                                        ...
                                                        <td><label> <input
                                                                    ...
                                                                    value="<?php echo $role; ?>"
                                                                    <?php if (in_array($role, $options['ga_dash_access_back']) OR $role == 'administrator') echo 'checked="checked"';
                                                                    if ($role == 'administrator') echo 'disabled="disabled"'; ?> />
                                                                <?php echo $name; ?>
                                                            </label></td>
                                                    <?php
                                    ...
                                    <tr>
                                        <td colspan="2" class="title">
                                            ...
                                            <div
                                                class="switch-desc"><?php _e("disable Switch Profile/View functionality", 'ga-dash'); ?></div>

                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <hr><?php echo "<h2>" . __("Real-Time Settings", 'ga-dash') . "</h2>"; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"
                                            class="title"> <?php _e("Maximum number of pages to display on real-time tab:", 'ga-dash'); ?>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <hr><?php echo "<h2>" . __("Additional Stats & Charts", 'ga-dash') . "</h2>"; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="title">
                                            ...
                                            <div
                                                class="switch-desc"><?php _e(" show Geo Map chart for visits", 'ga-dash'); ?></div>
                                    ...
                                    <tr>
                                        <td colspan="2" class="title">
                                            ...
                                            <div
                                                class="switch-desc"><?php _e(" show traffic overview", 'ga-dash'); ?></div>
                                    ...
                                    <tr>
                                        <td colspan="2" class="title">
                                            ...
                                            <div
                                                class="switch-desc"><?php _e(" show top referrers", 'ga-dash'); ?></div>
                                ...
                                <table class="options">
                                    ...
                                    <tr>
                                        <td class="title"><label
                                                for="ga_dash_tracking"><?php _e("Tracking Options: ", 'ga-dash'); ?></label>
                                        </td>
                                    ...
                                    if ($options ['ga_dash_tracking']) {
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <hr><?php echo "<h2>" . __("Tracking Code", 'ga-dash') . "</h2>"; ?>
                                            </td>
                                        </tr>
                                        <?php
                                        if ($options ['ga_dash_tracking'] == 1) {
                                            ...
                                            <tr>
                                                <td class="title"><label
                                                        for="ga_dash_tracking_type"><?php _e("Tracking Type: ", 'ga-dash'); ?></label>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="title"><label
                                                        for="ga_speed_samplerate"><?php _e("Page Speed SR:", 'ga-dash'); ?></label>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="2" class="title">
                                                    ...
                                                    <div
                                                        class="switch-desc"><?php _e(" anonymize IPs while tracking", 'ga-dash'); ?></div>
                                            ...
                                            <tr>
                                                <td colspan="2" class="title">
                                                    ...
                                                    <div
                                                        class="switch-desc"><?php _e(" enable enhanced link attribution", 'ga-dash'); ?></div>
                                                ...
                                                <td colspan="2" class="title">
                                                    ...
                                                    <div class="onoffswitch">
                                                        <input type="checkbox" name="options[ga_dash_remarketing]"
                                                            ...
                                                            <?php checked($options['ga_dash_remarketing'], 1); ?>>
                                                        <label
                                                    ...
                                                    <div
                                                        class="switch-desc"><?php _e(" enable remarketing, demographics and interests reports", 'ga-dash'); ?></div>
                                            ...
                                            <tr>
                                                <td colspan="2" class="title">
                                                    ...
                                                    <div
                                                        class="switch-desc"><?php _e(" enable AdSense account linking", 'ga-dash'); ?></div>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <hr><?php echo "<h2>" . __("Events Tracking", 'ga-dash') . "</h2>"; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" class="title">
                                                ...
                                                <div
                                                    class="switch-desc"><?php _e(" track downloads, mailto and outbound links", 'ga-dash'); ?></div>

                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="title"><label
                                                    for="ga_event_downloads"><?php _e("Download Filters:", 'ga-dash'); ?></label>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="title"></td>
                                            <td>
                                                <div class="event-option"><input type="checkbox"
                                                                                 name="options[ga_event_bouncerate]"
                                                                                 value="1" id="ga_event_bouncerate"
                                                        <?php checked($options['ga_event_bouncerate'], 1); ?>> <label
                                                        for="ga_event_bouncerate">
                                                    </label></div>
                                                <div
                                                    class="event-option-desc"><?php _e(" exclude the event hit from bounce-rate calculation", 'ga-dash'); ?></div>

                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <hr><?php echo "<h2>" . __("Exclude Tracking", 'ga-dash') . "</h2>"; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="roles title"><label
                                                    for="ga_track_exclude"><?php _e("Exclude tracking for: ", 'ga-dash'); ?></label>
                                            </td>
                                            <td class="roles">
                                                <?php
                                                if (!isset ($wp_roles)) {
	...
	<div id="post-body" class="metabox-holder columns-2">
        ...
        if (isset ($_POST ['Authorize'])) {
            ...
            if ($options ['ga_dash_token']) {
                ...
                <tr>
                    <td class="title"><label
                            for="ga_dash_tableid_jail"><?php _e("Select Domain: ", 'ga-dash'); ?></label></td>
                ...
                foreach (wp_get_sites() as $blog) {
                    ...
                    <tr>
                        <td class="title-select"><label
                                for="ga_dash_tableid_network"><?php echo '<strong>' . $blog['domain'] . $blog['path'] . '</strong>: '; ?></label>
                        </td>
