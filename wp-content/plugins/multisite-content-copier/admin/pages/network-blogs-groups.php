    ...
    public function render_group_edit_screen()
    {
        ...
        <?php
            ...
            if (isset($_GET['updated'])) {
                ?>
                <div class="updated"><p><?php _e('The Group has been updated.', MULTISTE_CC_LANG_DOMAIN); ?> <a
                            href="<?php echo esc_url($this->get_permalink()); ?>"><?php _e('Back to Groups list', MULTISTE_CC_LANG_DOMAIN); ?></a>
                    </p></div>
            <?php
            } elseif (mcc_is_error()) {
                mcc_show_errors();
            ...
            <form action="" method="post">
                ...
                <p class="submit">
                    ...
                    <a href="<?php echo esc_url($this->get_permalink()); ?>"
                       class="button-secondary"><?php _e('Cancel', MULTISTE_CC_LANG_DOMAIN); ?></a>
                </p>
            </form>
        <?php
        }
                    ...
                    <div class="form-wrap">
                        ...
                        <form id="mcc-groups-table-form" action="" method="post">
                            ...
                            <p class="submit"><input type="submit" name="submit_new_group" id="submit_new_group"
                                                     ...
                                                     value="<?php _e('Add New Group', MULTISTE_CC_LANG_DOMAIN); ?>"></p>
                        </form>
                    </div>
                </div>
            </div>
