    ...
    function extra_tablenav($which)
    {
        if ('top' == $which) {
            ...
            <div class="alignleft actions">
                ...
                <input type="submit" name="mcc-assign-group" id="mcc-assign-group" class="button"
                       value="<?php _e('Assign to Group', MULTISTE_CC_LANG_DOMAIN); ?>">
                <input type="submit" name="mcc-remove-from-group" id="mcc-remove-group" class="button"
                       value="<?php _e('Remove from Group', MULTISTE_CC_LANG_DOMAIN); ?>">
            </div>
            <script>
