...
<p>Detta är migreringshanteraren för BytBil CMS. Den kan användas för att uppdatera Advanced Custom Fields för alla
    siter i ett nätverk.</p>
    ...
    <div class="col">
        <form class="submit-migration" action="" method="get">
            <label for="field-theme">
                <input name="page" type="hidden" value="bbcms-migrations"/>
        ...
        <form class="submit-migration" action="<?php echo get_admin_url() ?>admin-post.php" method="post">
            <input name="action" type="hidden" value="migration-submit"/>
            ...
            <label for="new-val">
                <input id="new-val" type="text" name="field-value" placeholder="Nytt värde"/>
            </label>
            <label for="noop">
