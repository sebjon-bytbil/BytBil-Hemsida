...
<h3>Update Values</h3>
<p>Man kan ändra värdet i ett fält och applicera det på alla/valfria sajter i ett nätverk</p>
    ...
    <div class="col">
        <form class="submit-migration" action="" method="get">
            <label for="field-theme">
                <input name="page" type="hidden" value="update-values"/>
        ...
        <form class="submit-migration" action="<?php echo get_admin_url() ?>admin-post.php" method="post">
            <input name="action" type="hidden" value="update-values-submit"/>
