...
class MCC_Posts_List_Table extends WP_List_Table
{
    ...
    {
        return '<input type="checkbox" name="post_ids[]" ' . checked(in_array($item->ID, $this->selected), true, false) . ' id="post_id_' . $item->ID . '" class="post_id" value="' . $item->ID . '">';
    }
    ...
    function extra_tablenav($which)
    {
        ...
        <div class="alignleft actions">
            <input type="submit" name="" id="doaction" class="button-primary action"
                   value="<?php echo esc_attr(__('Add items to the list', MULTISTE_CC_LANG_DOMAIN)); ?>">
        </div>
        <div class="alignleft actions">
            <?php $dropdowns = ''; ?>
            ...
            <?php if (!empty($dropdowns)): ?>
                <?php echo $dropdowns; ?>
                <input type="submit" name="filter" id="filter" class="button action"
                       value="<?php echo esc_attr(__('Filter', MULTISTE_CC_LANG_DOMAIN)); ?>">
            <?php endif; ?>
        </div>
        <div class="alignleft actions">
