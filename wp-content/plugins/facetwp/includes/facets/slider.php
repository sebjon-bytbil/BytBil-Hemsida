...
?>
<link href="<?php echo FACETWP_URL; ?>/assets/js/noUiSlider/nouislider.min.css" rel="stylesheet">
<script src="<?php echo FACETWP_URL; ?>/assets/js/noUiSlider/nouislider.min.js"></script>
