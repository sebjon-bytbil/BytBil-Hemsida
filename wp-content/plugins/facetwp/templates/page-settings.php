...
<div class="wrap">
    ...
    <div class="facetwp-region facetwp-region-welcome about-wrap">
        <h1><?php _e( 'Welcome to FacetWP - This Plugin Shared By WWW.Null24.IR', 'fwp' ); ?></h1>
        ...
        <div class="welcome-box-wrap">
            <div class="welcome-box">
                <h2><?php _e( 'Facets - wWw.Null24.IR', 'fwp' ); ?></h2>
            ...
            <div class="welcome-box">
                <h2><?php _e( 'Templates - WwW.Null24.IR', 'fwp' ); ?></h2>
    ...
    <div class="facetwp-region facetwp-region-settings">
        ...
        <div class="facetwp-content-wrap">
            <table>
                <tr>
                    <td style="width:175px"><?php _e( 'License Key - wWw.Null24.IR', 'fwp' ); ?></td>
                    <td>
