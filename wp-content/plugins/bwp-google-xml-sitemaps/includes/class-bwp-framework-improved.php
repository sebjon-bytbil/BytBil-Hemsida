        ...
        if (true == $info_showable || (self::is_multisite() && is_super_admin())) {
            ...
            <div id="bwp-info-place">
                <div id="bwp-donation" style="margin-bottom: 0px;">
                    ...
                    <small>v<?php echo $this->plugin_ver; ?></small>
                    <br/>
                    <small>
                        <a href="<?php echo str_replace('/wordpress-plugins/', '/topic/', $this->plugin_url); ?>"><?php _e('Development Log', $this->plugin_dkey); ?></a> &ndash;
                        <a href="<?php echo $this->plugin_url . 'faq/'; ?>"
                           title="<?php _e('Frequently Asked Questions', $this->plugin_dkey) ?>"><?php _e('FAQ', $this->plugin_dkey); ?></a> &ndash;
                        <a href="http://betterwp.net/contact/"
                        ...
                        <form class="paypal-form" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                            <p>
                                ...
                                <input type="hidden" name="item_name"
                                       value="<?php printf(__('Donate to %s', $this->plugin_dkey), $this->plugin_title); ?>"/>
                                <select name="amount">
                                    ...
                                    <option
                                        value="50.00"><?php _e('One LL-cup!!! $50.00', $this->plugin_dkey); ?></option>
                                    <option
                                        value="100.00"><?php _e('... or any amount!', $this->plugin_dkey); ?></option>
                                </select>
                                <span class="paypal-alternate-input" style="display: none;"><!-- --></span>
                                <input class="paypal-submit" type="image"
                                       src="<?php echo $this->plugin_wp_url . 'includes/bwp-option-page/images/icon-paypal.gif'; ?>"
                ...
                <div id="bwp-contact">
                    <a class="bwp-rss"
                       href="http://feeds.feedburner.com/BetterWPnet"><?php _e('Latest updates from BetterWP.net!', $this->plugin_dkey); ?></a>
                    <a class="bwp-twitter"
                       href="http://twitter.com/0dd0ne0ut"><?php _e('Follow me on Twitter!', $this->plugin_dkey); ?></a>
                </div>
                <?php
                if (true == $ad_showable) {
                    ?>
                    ...
                    <div id="bwp-ads">
                        ...
                        <div style="width: 250px; margin: 0 auto;">
                            <a href="http://bit.ly/<?php echo $this->plugin_dkey; ?>-mwp" target="_blank">
                                <img
                                    src="<?php echo $this->plugin_wp_url . 'includes/bwp-option-page/images/ad_250x250.png'; ?>"/>
                            </a>
                        </div>
                    </div>
                <?php
