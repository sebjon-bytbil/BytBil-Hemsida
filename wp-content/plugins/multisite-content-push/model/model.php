 ...
 */
class Multisite_Content_Push_Model
{
    ...
    // TODO: Change slug
    public $schema_created_option_slug = 'mcp_schema_created';
    ...
    protected function __construct()
    {
        ...
        $this->queue_table = $wpdb->base_prefix . 'mcp_queue';
        $this->blogs_groups_table = $wpdb->base_prefix . 'mcp_blogs_groups';
        $this->blogs_groups_relationship_table = $wpdb->base_prefix . 'mcp_blogs_groups_relationship';
    ...
    public function get_queued_elements_for_blog($blog_id)
    {
        ...
        //$wpdb->prepare( "SELECT * FROM $this->queue_table WHERE src_blog_id = %d", $blog_id )
