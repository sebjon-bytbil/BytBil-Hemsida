    ...
    class WPMUDEV_Dashboard_Notice3
    {
        ...
        function is_allowed_screen()
        {
            ...
            if (is_array($updates) && count($updates)) {
                ...
                if (in_array($this->screen_id, array('plugins', 'update-core', /*'plugin-install', 'theme-install',*/
                    'plugins-network', 'themes-network', /*'theme-install-network', 'plugin-install-network',*/
                    'update-core-network')))
                    return true;
            }
        ...
        function notice_styles()
        {
            ...
            <style type="text/css" media="all">
                ...
                #wpmu-install-dashboard .wpmu-button {
                    width: auto;
                    position: absolute;
                    top: 0;
                    bottom: 0;
                    ...
                    border: 5px solid rgba(53, 131, 191, 0.4);
                    vertical-align: middle;
                    text-shadow: 0 1px 0 rgba(0, 0, 0, 0.6)
                }

                #wpmu-install-dashboard .wpmu-button:hover {
                    color: #e8da42;
                    border-color: rgba(53, 131, 191, 0.9);
                    -webkit-transition: 0.2s
                }

                #wpmu-install-dashboard .wpmu-message {
                    color: #c0d7eb;
                ...
                #wpmu-install-dashboard .wpmu-button, #wpmu-install-dashboard .wpmu-button:hover {
                    -webkit-transition: 0.2s
                }

                #wpmu-install-dashboard .wpmu-btn-wrap {
                    min-width: 10%;
                    background-color: #fff
                }

                #wpmu-install-dashboard .wpmu-install-wrap {
                    max-width: 1050px;
                    margin: 0 auto;
                    position: relative
                }

                #wpmu-install-dashboard .wpmu-more-wrap {
                    max-width: 1050px;
                    margin: 0 auto -9px;
                    padding: 5px 0 0;
                    text-align: right
                ...
                #the-list .wpmu-update-row a {
                    color: #3bb2df
                }

                #the-list .wpmu-update-row a:hover {
                    color: #e8da42;
                    -webkit-transition: 0.2s
                }
            </style>
