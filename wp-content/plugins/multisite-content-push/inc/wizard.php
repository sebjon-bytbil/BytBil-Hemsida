...
class MCP_Wizard
{
    ...
    {
        return isset($_SERVER['mcp_wizard']['initialized']);
    }
    ...
    {
        if (isset($_SESSION['mcp_wizard'][$key]))
            return $_SESSION['mcp_wizard'][$key];
    ...
    {
        $_SESSION['mcp_wizard'][$key] = $value;
    }

    public function clean()
    {
        $this->initialized = false;
        unset($_SESSION['mcp_wizard']);
    }
