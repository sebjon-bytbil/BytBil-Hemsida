...
if (!class_exists('Multisite_Content_Push_Admin_Page')) {
    abstract class Multisite_Content_Push_Admin_Page
    {
        ...
        public function check_for_scripts($hook)
        {
            if ($hook === $this->page_id) {
                ...
                try {
                    ...
                    Multisite_Content_Push_Errors_Handler::show_exception($e->getMessage());
                }
        ...
        private function the_tabs()
        {
            ...
            foreach ($this->tabs as $key => $name): ?>
                <a href="?page=<?php echo $this->get_menu_slug(); ?>&tab=<?php echo $key; ?>"
                   class="nav-tab <?php echo $current_tab == $key ? 'nav-tab-active' : ''; ?>"><?php echo $name; ?></a>
            <?php endforeach;
