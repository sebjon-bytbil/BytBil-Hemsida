 ...
 */
class Multisite_Content_Push_Settings_Handler
{

    static $instance;

    // Settings slug for DB
    private $settings_slug = 'multisite_content_push_settings';
    ...
    public function __construct()
    {
        $this->additional_settings = array(
            'post' => array(
                'push_images' => __('Copy images (required for featured images)', MULTISTE_CP_LANG_DOMAIN),
                'update_date' => __('Update post created date', MULTISTE_CP_LANG_DOMAIN),
                'push_parents' => __('Copy parents', MULTISTE_CP_LANG_DOMAIN),
                'push_comments' => __('Copy comments', MULTISTE_CP_LANG_DOMAIN),
                'push_terms' => __('Copy terms ( Tags & Categories )', MULTISTE_CP_LANG_DOMAIN)
            ),
            'page' => array(
                'push_images' => __('Copy images', MULTISTE_CP_LANG_DOMAIN),
                'update_date' => __('Update page created date', MULTISTE_CP_LANG_DOMAIN),
                'push_parents' => __('Copy parents', MULTISTE_CP_LANG_DOMAIN),
                'push_comments' => __('Copy comments', MULTISTE_CP_LANG_DOMAIN)
            ),
            'cpt' => array(
