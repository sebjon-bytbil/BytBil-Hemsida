...
class MCP_Plugins_List_Table extends WP_List_Table
{
    ...
    function __construct()
    {
        ...
        parent::__construct(array(
            'singular' => __('Plugin', MULTISTE_CP_ADMIN_DIR),
            'plural' => __('Plugins', MULTISTE_CP_ADMIN_DIR),
            'ajax' => false
        ));
    ...
    function get_columns()
    {
        $columns = array(
            ...
            'name' => __('Plugin name', MULTISTE_CP_ADMIN_DIR),
            'description' => __('Plugin description', MULTISTE_CP_ADMIN_DIR)
        );
        return $columns;
    }
