...
class MCP_NBT_Groups_List_Table extends WP_List_Table
{
    ...
    function __construct()
    {
        ...
        parent::__construct(array(
            'singular' => __('Blog Templates Group', MULTISTE_CP_ADMIN_DIR),
            'plural' => __('Blog Templates Groups', MULTISTE_CP_ADMIN_DIR),
            'ajax' => false
        ));
    ...
    {
        $columns = array(
            'name' => __('Template name', MULTISTE_CP_ADMIN_DIR),
            'description' => __('Template description', MULTISTE_CP_ADMIN_DIR),
            'count' => __('Sites', MULTISTE_CP_ADMIN_DIR)
        );
        return $columns;
    }
