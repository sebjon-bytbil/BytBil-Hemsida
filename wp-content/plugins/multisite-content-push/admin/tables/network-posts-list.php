...
class MCP_Posts_List_Table extends WP_List_Table
{
    function __construct($args = array())
    {
        ...
        parent::__construct(array(
            'singular' => __('Post', MULTISTE_CP_LANG_DOMAIN),
            'plural' => __('Posts', MULTISTE_CP_LANG_DOMAIN),
            'ajax' => false
        ));
    }
    ...
    function get_columns()
    {
        ...
        $sites_columns = array(
            ...
            'title' => __('Title', MULTISTE_CP_LANG_DOMAIN),
            'status' => __('Status', MULTISTE_CP_LANG_DOMAIN),
            'date' => __('Created', MULTISTE_CP_LANG_DOMAIN)
        );
    ...
    function extra_tablenav($which)
    {
        ...
        <div class="alignleft actions">
            <input type="submit" name="" id="doaction" class="button action"
                   value="<?php echo esc_attr(__('Add items to the list', MULTISTE_CP_LANG_DOMAIN)); ?>">
        </div>
        <div class="alignleft actions">
