<div id="vc_properties-panel"
	...
	<div class="vc_panel-heading">
		<a title="<?php _e( 'Stäng panel', 'js_composer' ); ?>" href="#" class="vc_close" data-dismiss="panel"
		   aria-hidden="true"><i class="vc_icon"></i></a>
		<a title="<?php _e( 'Dölj panel', 'js_composer' ); ?>" href="#" class="vc_transparent" data-transparent="panel"
		   aria-hidden="true"><i class="vc_icon"></i></a>
	...
	<div class="vc_panel-footer">
		<button type="button" class="vc_btn vc_panel-btn-close vc_close vc_btn-default"
		        data-dismiss="panel"><?php _e( 'Stäng', 'js_composer' ) ?></button>
