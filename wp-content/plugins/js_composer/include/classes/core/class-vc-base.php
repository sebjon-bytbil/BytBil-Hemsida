...
class Vc_Base {
	...
	public function registerAdminJavascript() {
		...
		wp_localize_script( 'wpb_js_composer_js_view', 'i18nLocale', apply_filters( 'vc_i18n_locale_composer_js_view', array(
			'add_remove_picture' => __( 'Lägg till/ta bort bild', 'js_composer' ),
			'finish_adding_text' => __( 'Färdig med att lägga till', 'js_composer' ),
			'add_image' => __( 'Lägg till bild', 'js_composer' ),
			'add_images' => __( 'Lägg till bilder', 'js_composer' ),
			'settings' => __( 'Inställningar', 'js_composer' ),
			'main_button_title' => __( 'BytBil CMS Innehållshantering', 'js_composer' ),
			'main_button_title_backend_editor' => __( 'Backend Redigering', 'js_composer' ),
			'main_button_title_frontend_editor' => __( 'Live Redigering (rekommenderas)', 'js_composer' ),
			'main_button_title_revert' => __( 'Utvecklarläge', 'js_composer' ),
			'please_enter_templates_name' => __( 'Vänligen fyll i sidmallens namn', 'js_composer' ),
			'confirm_deleting_template' => __( 'Bekräfta ett du vill ta bort "{template_name}". Tryck avbryt för att stänga fönstret - denna åtgärd kan ej ångras.', 'js_composer' ),
			'press_ok_to_delete_section' => __( 'Tryck OK för att ta bort sektionen, avbryt för att gå tillbaka.', 'js_composer' ),
			'drag_drop_me_in_column' => __( 'Drag och släpp mig i en kolumn', 'js_composer' ),
			'press_ok_to_delete_tab' => __( 'Tryck OK för att ta bort "{tab_name}", avbryt för att gå tillbaka.', 'js_composer' ),
			'slide' => __( 'Slide', 'js_composer' ),
			'tab' => __( 'Tabb', 'js_composer' ),
			'section' => __( 'Sektion', 'js_composer' ),
			'please_enter_new_tab_title' => __( 'Vänligen fyll i en titel för Tabben.', 'js_composer' ),
			'press_ok_delete_section' => __( 'Press OK to delete "{tab_name}" section, Cancel to leave', 'js_composer' ),
			'section_default_title' => __( 'Sektion', 'js_composer' ),
			'please_enter_section_title' => __( 'Vänligen fyll i en titel för Sektionen.', 'js_composer' ),
			...
			'loading' => __( 'Laddar...', 'js_composer' ),
			// Media editor
			'set_image' => __( 'Ställ in bild', 'js_composer' ),
			...
			'row_background_color' => __( 'Radens bakgrundsfärg', 'js_composer' ),
			'row_background_image' => __( 'Radens bakgrundsbild', 'js_composer' ),
			'column_background_color' => __( 'Kolumnens bakgrundsfärg', 'js_composer' ),
			'column_background_image' => __( 'Kolumnens bakgrundsbild', 'js_composer' ),
			'guides_on' => __( 'Guider PÅ', 'js_composer' ),
			'guides_off' => __( 'Guider AV', 'js_composer' ),
			'template_save' => __( 'Ny sidmall har skapats!', 'js_composer' ),
			'template_added' => __( 'Sidmall applicerad på din sida.', 'js_composer' ),
			...
			'template_removed' => __( 'Sidmall borttagen.', 'js_composer' ),
			'template_is_empty' => __( 'Nothing to save. Template is empty.', 'js_composer' ),
			'css_updated' => __( 'Page settings updated!', 'js_composer' ),
			'update_all' => __( 'Uppdatera alla', 'js_composer' ),
			'confirm_to_leave' => __( 'Dina ändringar kan förloras om du navigerar ifrån sidan nu..', 'js_composer' ),
			'inline_element_saved' => __( '%s sparad!', 'js_composer' ),
			'inline_element_deleted' => __( '%s borttagen!', 'js_composer' ),
			'inline_element_cloned' => __( '%s duplicerad. <a href="#" class="vc_edit-cloned" data-model-id="%s">Redigera nu?</a>', 'js_composer' ),
	...
	public function pluginActionLinks( $links, $file ) {
		if ( $file == plugin_basename( vc_path_dir( 'APP_DIR', '/js_composer.php' ) ) ) {
			$link = '<a title="' . __( 'BytBil CMS Inställningar', 'js_composer' ) . '" href="' . esc_url( $this->getSettingsPageLink() ) . '">' . esc_html__( 'Settings', 'js_composer' ) . '</a>';
