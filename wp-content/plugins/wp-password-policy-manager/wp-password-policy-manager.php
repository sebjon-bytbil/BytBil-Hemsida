    ...
    function ModifyLoginForm()
    {
        ...
        <p>
            <label for="user_pass_new"><?php _e('New Password') ?><br/>
                <input type="password" name="user_pass_new" id="user_pass_new" class="input" value="<?php echo ''; ?>"
                       size="25"/></label>
        </p>
        <p>
            <label for="user_pass_vfy"><?php _e('Verify Password') ?><br/>
                <input type="password" name="user_pass_vfy" id="user_pass_vfy" class="input" value="<?php echo ''; ?>"
                       size="25"/></label>
        </p>
        ...
        if (wp_check_password($password, $user->data->user_pass, $user->ID) && ($wasReset || $this->IsUserPasswordOld($user))) {
            ...
            if (isset($_REQUEST['user_pass_new']) && isset($_REQUEST['user_pass_vfy'])) {
                ...
                if ($wasReset) {
                    ...
                    $diff = human_time_diff(strtotime($this->GetPasswordTtl(), $this->GetPasswordLastModTime($user->ID)), current_time('timestamp'));
                }
...
// </editor-fold>
    ...
    public function ManageWpOptions()
    {
            ...
            try {
                switch (true) {
                    ...
                    case isset($_POST[self::DEF_PFX . '_rst']):
                        ...
                        ?>
                        <div class="updated"><p><strong><?php _e('All passwords have been reset.'); ?></strong></p>
                        </div><?php
                        break;
                    default:
                ...
                ?>
                <div class="error"><p><strong><?php _e(__('Error') . ': ' . $ex->getMessage()); ?></strong></p>
                </div><?php
            }
        }
        ...
        <form method="post" id="wppm_settings">
            ...
            <div id="wppm-adverts">
                <a href="http://www.wpwhitesecurity.com/plugins-premium-extensions/email-notifications-wordpress/?utm_source=wppmplugin&utm_medium=settingspage&utm_campaign=notifications"
                   target="_blank">
                    <img src="<?php echo $this->GetBaseUrl();?>/img/notifications_250x150.gif" width="250" height="150"
                         alt="">
                </a>
                <a href="http://www.wpwhitesecurity.com/plugins-premium-extensions/search-filtering-extension/?utm_source=wppmplugin&utm_medium=settingspage&utm_campaign=search"
                   target="_blank">
                    <img src="<?php echo $this->GetBaseUrl();?>/img/search_250x150.gif" width="250" height="150" alt="">
                </a>
                <a href="http://www.wpwhitesecurity.com/plugins-premium-extensions/wordpress-reports-extension/?utm_source=wppmplugin&utm_medium=settingspage&utm_campaign=reports"
                   target="_blank">
                    <img src="<?php echo $this->GetBaseUrl();?>/img/reporting_250x150.gif" width="250" height="150"
                         alt="">
                </a>
            </div>
            <table class="form-table">
                ...
                <tr valign="top">
                    <th scope="row"><label
                            for="<?php $this->EchoIdent('ttl'); ?>"><?php _e('Password Expiration Policy'); ?></label>
                    </th>
                    <td>
                        <input type="text" id="<?php $this->EchoIdent('ttl'); ?>"
                               name="<?php $this->EchoIdent('ttl'); ?>"
                               value="<?php echo esc_attr($this->GetPasswordTtl()); ?>" size="20"
                ...
                <tr valign="top">
                    <th scope="row"><label
                            for="<?php $this->EchoIdent('len'); ?>"><?php _e('Password Length Policy'); ?></label></th>
                    <td>
                        <select type="text" id="<?php $this->EchoIdent('len'); ?>"
                                name="<?php $this->EchoIdent('len'); ?>"><?php
                ...
                <tr valign="top">
                    <th scope="row"><label
                            for="<?php $this->EchoIdent('cpt'); ?>"><?php _e('Mixed Case Policy'); ?></label></th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text"><span><?php _e('Mixed Case Policy'); ?></span></legend>
                            <label for="<?php $this->EchoIdent('cpt'); ?>">
                                <input name="<?php $this->EchoIdent('cpt'); ?>" type="checkbox"
                                       id="<?php $this->EchoIdent('cpt'); ?>"
                ...
                <tr valign="top">
                    <th scope="row"><label
                            for="<?php $this->EchoIdent('num'); ?>"><?php _e('Numeric Digits Policy'); ?></label></th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text"><span><?php _e('Numeric Digits Policy'); ?></span>
                            </legend>
                            <label for="<?php $this->EchoIdent('num'); ?>">
                                <input name="<?php $this->EchoIdent('num'); ?>" type="checkbox"
                                       id="<?php $this->EchoIdent('num'); ?>"
                ...
                <tr valign="top">
                    <th scope="row"><label
                            for="<?php $this->EchoIdent('spc'); ?>"><?php _e('Special Characters Policy'); ?></label>
                    </th>
                    <td>
                        <fieldset>
                            <legend class="screen-reader-text"><span><?php _e('Special Characters Policy'); ?></span>
                            </legend>
                            <label for="<?php $this->EchoIdent('spc'); ?>">
                                <input name="<?php $this->EchoIdent('spc'); ?>" type="checkbox"
                                       id="<?php $this->EchoIdent('spc'); ?>"
                ...
                <tr valign="top">
                    <th><label for="<?php $this->EchoIdent('msp'); ?>"><?php _e('Password History Policy'); ?></label>
                    </th>
                    <td>
                        <fieldset>
                            <?php _e('Remember'); ?>
                            <select type="text" id="<?php $this->EchoIdent('msp'); ?>"
                                    name="<?php $this->EchoIdent('msp'); ?>"><?php
                ...
                <tr>
                    <th><label for="ExemptTokenQueryBox"><?php _e('Users and Roles Exempt From Policies'); ?></label>
                    </th>
                    <td>
                        <fieldset>
                            <input type="text" id="ExemptTokenQueryBox"
                                   style="float: left; display: block; width: 250px;">
                            <input type="button" id="ExemptTokenQueryAdd" style="float: left; display: block;"
                ...
                <tr valign="top">
                    <th scope="row"><label for="rst-submit-button"><?php _e("Reset All Users' Passwords");?></label>
                    </th>
                    <td><input id="rst-submit-button" type="submit" name="<?php $this->EchoIdent('rst'); ?>"
                               class="button-secondary" value="<?php esc_attr_e(__('Reset All Passwords')); ?>"
                               onclick="return confirm(<?php esc_attr_e(json_encode(__('Are you sure you want to reset all passwords?'))); ?>);"/>
                    </td>
                </tr>
            ...
            <p class="submit">
                <input type="submit" name="<?php $this->EchoIdent('snt'); ?>" class="button-primary"
                       value="<?php esc_attr_e(__('Save Changes')); ?>"/>
            </p>
        </form>
        </div><?php
    }
