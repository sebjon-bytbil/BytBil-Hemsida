...
function disable_default_dashboard_widgets_sitesettings()
{
...
add_action('admin_menu', 'disable_default_dashboard_widgets_sitesettings');
...
{
    wp_register_style('dashboard_css', '/dashboard.css', false, '1.0.0');
