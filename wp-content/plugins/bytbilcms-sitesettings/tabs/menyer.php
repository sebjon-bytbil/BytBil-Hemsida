...
<?php if (get_field('sitesetting-edit-menus', $sid)) : ?>
    <?php
    $locations = get_field("sitesetting-font-other-locations", $sid);
    $useCustom = get_field("sitesetting-font-family-header", $sid) == "annat";
    if ($useCustom) {
        $font = get_field("sitesetting-font-other-name", $sid);
    }

    if ($useCustom && in_array("menuTopLevel", $locations)) {
        $topFont = $font;
    } else {
        $topFont = "'" . get_field("sitesetting-menus-font-family", $sid) . "', sans-serif;";
    }

    if ($useCustom && in_array("menuSubMenu", get_field("sitesetting-font-other-locations", $sid))) {
        $subFont = $font;
    } else {
        $subFont = "'" . get_field("sitesetting-submenu-font-family", $sid) . "', sans-serif;";
    }

    if ($useCustom && in_array("menuSidebar", get_field("sitesetting-font-other-locations", $sid))) {
        $sideFont = $font;
    } else {
        $sideFont = "'" . get_field("sitesetting-sidebarmenus-font-family", $sid) . "', sans-serif;";
    }
    ?>

    /* TOPPNIVÅ */
    .nav > li > a {
    font-family: <?php echo $topFont; ?>;
    ...
    <?php if (get_field('sitesetting-submenu-link-effect', $sid)) : ?>
        ...
        <?php if (in_array('bold', get_field('sitesetting-submenu-link-effect', $sid))) : ?>
            font-weight: bold;
        <?php endif; ?>
        <?php if (in_array('ucase', get_field('sitesetting-submenu-link-effect', $sid))) : ?>
            text-transform: uppercase;
        <?php endif; ?>
    <?php endif; ?>
    }
