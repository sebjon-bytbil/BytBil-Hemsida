    ...
    */
    ...
    function create_field($field)
    {
        ...
        <div class="acf-file-uploader clearfix <?php echo $o['class']; ?>"
            ...
            <input class="acf-file-value" type="hidden" name="<?php echo $field['name']; ?>"
                ...
                <ul class="hl clearfix">
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            <a class="acf-file-name" href="<?php echo $o['url']; ?>"
                               target="_blank"><?php echo $o['name']; ?></a>
                        </p>
            ...
            <div class="no-file">
                <ul class="hl clearfix">
                    <li>
                        <span><?php _e('No File Selected', 'acf'); ?></span>. <a href="#"
                                                                                 class="button add-file"><?php _e('Add File', 'acf'); ?></a>
                    </li>
                </ul>
            </div>
        </div>
