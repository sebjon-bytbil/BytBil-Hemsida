    ...
    class blog_templates
    {
        ...
        function admin_options_page()
        {
            ...
            <table width="100%" cellspacing="2" cellpadding="5" class="widefat fixed">
                ...
                <?php foreach ($this->options['templates'] as $key => $template) { ?>
                    <tr valign="top">
                        ...
                        <td><b><?php echo get_blog_option($template['blog_id'], 'blogname'); ?></b> <a
                                href="<?php echo get_blog_option($template['blog_id'], 'siteurl'); ?>/wp-admin">[Dashboard]</a>
                        </td>
                        <td><?php echo (isset($this->options['default']) && is_numeric($this->options['default']) && $this->options['default'] == $key) ? '<b>(Default)</b>' : '<a href="' . wp_nonce_url($url . '&default=' . $key, "blog_templates-make_default") . '">[Make Default]</a>'; ?>
                            <a href="<?php echo wp_nonce_url($url . '&d=' . $key, "blog_templates-delete_template") ?>">[Delete]</a>
                        </td>
                    </tr>
                <?php } ?>
            </table>
            ...
            <table width="100%" cellspacing="2" cellpadding="5" class="widefat fixed">
                ...
                <tr valign="top">
                    <th width="33%"><?php _e('Template Description:', $this->localization_domain); ?></th>
                    <td><textarea class="widefat" name="template_description" type="text" id="template_description" size="45"></textarea>
                </td>
                </tr>
                <tr valign="top">
                ...
                <?php if (is_plugin_active('sitewide-privacy-options/sitewide-privacy-options.php')): ?>
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                &nbsp;<label
                                        for='nbt-copy-status'><?php _e('Check if you want also to copy the blog status (Public or not)', $this->localization_domain); ?></label>
                            </span><br/>
                            </td>
                        </tr>
                    <?php endif; ?>
        ...
        <?php
            ...
            <table width="100%" cellspacing="2" cellpadding="5" class="widefat fixed">
                <tr valign="top">
                    ...
                    <td><input name="template_name" type="text" id="template_name" size="45" value="<?php esc_attr_e($template['name']); ?>"/>
                </td>
                </tr>
                <tr valign="top">
                    <th width="33%"><?php _e('Template Description:', $this->localization_domain); ?></th>
                    <td><textarea class="widefat" name="template_description" type="text" id="template_description" size="45"><?php echo esc_textarea($template['description']); ?></textarea>
                </td>
                </tr>
                <tr valign="top">
                    <th width="33%"><?php _e('What To Copy To New Blog?', $this->localization_domain); ?></th>
