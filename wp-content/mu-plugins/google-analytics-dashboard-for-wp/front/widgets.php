...
class GADSH_Frontend_Widget extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        <p>
            <label
                for="<?php echo $this->get_field_id('anonim'); ?>"><?php _e("Anonimize chart's stats:", 'ga-dash'); ?></label>
            <input class="widefat"
        ...
        <p>
            ...
            <select id="<?php echo $this->get_field_id('period'); ?>"
                ...
                <option
                    value="7daysAgo" <?php selected($period, '7daysAgo'); ?>><?php _e('Last 7 Days', 'ga-dash'); ?></option>
                <option
                    value="14daysAgo" <?php selected($period, '14daysAgo'); ?>><?php _e('Last 14 Days', 'ga-dash'); ?></option>
                <option
                    value="30daysAgo" <?php selected($period, '30daysAgo'); ?>><?php _e('Last 30 Days', 'ga-dash'); ?></option>
            </select>
        </p>
        <p>
            <label
                for="<?php echo $this->get_field_id('give_credits'); ?>"><?php _e("Give credits:", 'ga-dash'); ?></label>
            <input class="widefat"
